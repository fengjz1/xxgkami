    ...
    <div class="container">
        <div class="query-card">
            <div class="card-header">
                <h2><i class="fas fa-search"></i> 卡密查询</h2>
                <p>请输入您的卡密查询详细信息</p>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="card-result">
                    ...
                    <div class="result-grid">
                        ...
                        <div class="result-item">
                            <label>允许重复验证:</label>
                            <span class="status status-<?php echo $card_data['allow_reverify'] ? 'used' : 'unused'; ?>">
                                <?php echo $card_data['allow_reverify'] ? '是' : '否'; ?>
                            </span>
                        </div>
                    </div>
                </div>
